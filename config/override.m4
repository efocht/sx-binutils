dnl Fix Autoconf-2.61 bugs: by overriding broken internal
...
dnl We use it because this fix is intended for 2.61 only.
...
# --------------------
# The code is the same as autoconf 2.61, but with a more lenient check
...
# ----------------------------------------
# This is the same code as in 2.61 and 2.61, except it also outputs pwd.
