...
typedef struct coff_tdata
{
  ...
  /* these fields are present only in COFF/SX files */
  unsigned char   f_flags2;       /* object information flags */
  unsigned char   f_flags3;       /* object information flags */
  unsigned char   f_flttype;      /* floating-point data type */  
  short           aout_magic;     /* magic number for the optional COFF 
                                     header */
  bfd_vma         ssize;          /* stack size */
