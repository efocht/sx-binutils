...
struct internal_filehdr
{
  ...
  /* extra flags for COFF/SX format */
  unsigned char f_flags2;
  unsigned char f_flags3;
  unsigned char f_flttype;
};
...
#define F2_LP64         ((unsigned char)(1 << 7))
#define F2_SX3MEM       ((unsigned char)(1 << 6))
/* bits 2 and 3 unused */
#define F2_CLANG        ((unsigned char)(1 << 3))
#define F2_USEB6        ((unsigned char)(1 << 2))
#define F2_INT64        ((unsigned char)(1 << 1))
#define F2_VECINS       ((unsigned char)(1 << 0))

/* extra extra flags for SX COFF format */
#define F3_SIZE_TMIX    ((unsigned char)(1 << 7))
#define F3_SIZE_T64     ((unsigned char)(1 << 6))
#define F3_VL512ONLY    ((unsigned char)(1 << 5))
#define F3_VL512MAX     ((unsigned char)(1 << 4))
#define F3_P64          ((unsigned char)(1 << 3))
#define F3_PG0PRIV      ((unsigned char)(1 << 2))
#define F3_MEMFRT       ((unsigned char)(1 << 1))
#define F3_MLTTSK       ((unsigned char)(1 << 0))

/* floating point mode for SX COFF format */
#define FT_NON          ((unsigned char)0)
#define FT_FL1          ((unsigned char)1)
#define FT_FL2          ((unsigned char)2)
#define FT_MIX          ((unsigned char)3)
#define FT_FL0          ((unsigned char)4)
...
#define STYP_CPI        (0x1000)       /* for .CPI section: SX/COFF specific */
...
struct internal_syment
{
  union
  {
    char _n_name[MAX_SYMNMLEN];	/* old COFF version	*/
    struct
    {
...
#define R_SX_ABS 	 0 /* No relocation necessary */
#define R_SX_RELLONG	17 /* 32bit ref to symbol VA */
#define R_SX_RELLLNG	18 /* 64bit ref to symbol VA */
#define R_SX_RELPROC	19 /* 64bit proc ref to symbol VA */
#define R_SX_RELLCOM	20 /* 64bit ref to local common symbol VA */
